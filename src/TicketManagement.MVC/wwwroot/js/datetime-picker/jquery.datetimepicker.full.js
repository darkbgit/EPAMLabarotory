...
var datetimepickerFactory = function ($) {
	...
	var default_options  = {
		i18n: {
			be: { // Belarus
				months: [
					"Студзень", "Люты", "Красавік", "Сакавік", "Май", "Чэрвень", "Ліпень", "Жнівень", "Верасень", "Кастрычнік", "Лістапад", "Студзень"
				],
				dayOfWeekShort: [
					"Нд", "Пн", "Ат", "Ср", "Чц", "Пт", "Сб"
				],
				dayOfWeek: ["Нядзеля", "Панядзелак", "Аўторак", "Серада", "Чацвер", "Пятніца", "Субота"]
			},
			ar: { // Arabic
				months: [
